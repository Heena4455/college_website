...
<div class="main-page-wrapper">
			...
			<header class="theme-main-header">
				<div class="container">
					<a href="index.html" class="logo float-left tran4s"> <img src="images/logo/H1.jfif"></a>
					...
					<!--		<li><a href="index.html#project-section">SOCI</a></li>-->
							...
							<li class="dropdown-holder"><a href="academics.html">ACADEMICS</a>
								<ul class="sub-menu">
										...
										<li><a href="#" class="tran3s">MEC Faculty</a></li>
									</ul>
								</li>
			...
			<section class="inner-page-banner">
				<div class="opacity">
					<div class="container">
						<h2>GCE ENGINEERING COLLEGE</h2>
						<ul>
							<li><a href="index.html">ABOUT US</a></li>
							<li>:affiliated TO VTU</li>
						</ul>
					</div> <!-- /.container -->
				</div> <!-- /.opacity -->
			...
			<div class="col-sm-6 col-md-4 p-t-50">
				...
				<ul class="m-b-70">
					<li class="txt14 m-b-14">
						...
						GCE Engineering College 110020 - New Delhi
					</li>
